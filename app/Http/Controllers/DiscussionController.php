...
class DiscussionController extends Controller
{
     ...
     * @return void
     */
    public function __construct(MessageRepository $messages, DiscussionRepository $discussions)
    {
    ...
    /**
     * Display the thread of a discussion
     *
    ...
    public function getThread(Request $request)
    {
        ...
        elseif($request->input('entity_type')=="App\Models\QuestionAnswer")
    ...
    public function postNew(Request $request)
    {
        ...
        return view('discussion.thread',compact('user','entity','thread'));     
    }
