...
class StoreRecipe extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'anecdote' => 'max:2000',
            'cooking_time_hour' => 'integer|between:0,24',
            'cooking_time_minute' => 'integer|between:0,59',
            'preparation_time_hour' => 'integer|between:0,24',
            'preparation_time_minute' => 'integer|between:0,59',
            'servings' => 'integer|between:1,20',
