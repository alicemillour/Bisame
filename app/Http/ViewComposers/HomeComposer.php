...
//        get_users_and_annotation_counts())
        ...
        $progression = $this->annotationRepository->get_distinct_annotated_words($current_corpus)->count() * 100 / 10;//$this->annotationRepository->count_annotable_words($current_corpus)->count;
          $view
