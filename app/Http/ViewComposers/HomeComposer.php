...
//        get_users_and_annotation_counts())
        ...
        $progression_hoch = $this->annotationRepository->get_distinct_annotated_words(332)->count() * 100 / $this->annotationRepository->count_annotable_words(324)->count;
        ...
        $view
                ...
                ->with('total_sentences_Hoch', $this->wordRepository->get_sentences_number(332))
                ->with('total_words_Hoch', $this->wordRepository->get_words_number(332))
                ->with('progression_Hoch', $progression_hoch)
                ->with('unannotated_words_Hoch', $this->annotationRepository->get_unannotated_words(332));
    }
