...
<ol align=left style="padding-left: 15px">
    ...
    <div style="text-align:left"> Aujourd'hui <b class="ostrich">BISAME</b> c'est :  </div> 
           ...
           <h3> Un corpus de {{$total_distinct_words_annotated_not_ref}} mots distincts annotés collaborativement : <a href="{{ url('/download_txt/wikipedia-20160406-bisame.conll')  }}" target="_blank" style="font-size:0.7em"><b>Télécharger (CONLL)</b> </a>

               <h3> Un outil d'annotation automatique entraîné grâce à cette nouvelle ressource : <a href="{{ url('/download_zip/melt-20160406-bisame.tar.gz')  }}" target="_blank" style="font-size:0.7em"><b>Télécharger&nbsp;le&nbsp;modèle&nbsp;(MElt)</b> </a>
