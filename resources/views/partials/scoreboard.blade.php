<div class="scoreboard fancy-border">
    ...
    <div class="fancy-border">
        <ul class="nav nav-tabs">
            <li class="active" ><a data-toggle="pill" style="color:black" href="#home">Score global</a></li>
            <li><a data-toggle="pill" style="color:black" href="#menu1">Les plus prolifiques !</a></li>
        </ul>
